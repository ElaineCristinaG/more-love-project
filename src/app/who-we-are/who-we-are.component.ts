...
export class WhoWeAreComponent {
  ...
  public textHistory1: string = "O Projeto O Amor foi idealizado por uma mãe , a Deice, como muitas mães atípicas, na hora do recebimento do diagnóstico de autismo da sua filha mais nova entrou em desespero, se sentiu sozinha, se sentiu sem chão, sabia que o que ela tinha como resposta a esse turbilhão de sentimentos de medo, insegurança e receio era"
  public textHistory2: string = "Uma mãe que lutou e luta por todos os direitos e oportunidades que sua filha merece ter. Vendo a necessidade de ampliar e impactar outras famílias, criou um grupo de whatsapp e acabou conhecendo outras realidades além do autismo. Então sentiu que precisava consolidar a sua ideia de ajuda e acolhimento junto às outras familias."
  public textHistory3: string = "Foi então que se uniu com mais quatro mulheres e mães com a mesma ânsia e objetivo: de ajudar e transformar vida de pessoas e crianças com TEA: Andréa, Erica, Fabiana e Caru e fundaram a Associação."
  public textHistory4: string = "O projeto foi saindo das redes sociais e concretizando como"
